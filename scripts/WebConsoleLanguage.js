...
function setLanguage(locale){
	...
	switch(locale){
		...
		case "pt_BR": //Credit to AlexandreMuassab
			...
			break;
		case "zh_TW": //Credit to Neubulae
			lang = {
				"navbarHomeLink": "首頁",
				"home_header": "請從選單中選擇一個伺服器",
				"home_description": "請使用工具列添加新伺服器, 或連接至已設定的伺服器.",
				"serversDropdown": "你的伺服器",
				"add_server": "添加伺服器",
				"noServersAdded": "沒有添加伺服器",
				"lang_dropdown": "語言",
				"addServerModalLongTitle": "添加一個新伺服器",
				"addServerModalSvName": "伺服器名稱:",
				"addServerModalSvIp": "伺服器IP位址:",
				"addServerModalSvPort": "WebConsole接口:",
				"addServerModalSvSsl": "伺服器已啟用SSL",
				"addServerModalSslAdvice": "HTTPS客戶端連接需要SSL",
				"addServerModalClose": "關閉",
				"saveAndConnectServerButton": "保存並連接",
				"passwordModalLongTitle": "需要密碼",
				"passwordModalLabel": "密碼:",
				"passwordModalRememberLabel": "記住密碼",
				"passwordModalCloseButton": "關閉",
				"passwordSendButton": "登錄",
				"disconnectionModalLongTitle": "已斷開連線",
				"disconnectionModalDescription": "與伺服器的連線丢失, 可能是因為：",
				"disconnectionModalsub1": "伺服器是有意關閉的。",
				"disconnectionModalsub2": "您的主機上的端口未打開。 如果是這種情況，請使用端口測試工具進行故障排除，然後再次檢查防火牆或路由器。",
				"disconnectionModalCloseButton": "關閉",
				"disconnectionModalWelcomeScreenButton": "返回主頁面",
				"settingsLink": "設定值",
				"settingsModalLongTitle": "WebConsole 設定值",
				"showDateSettingsSwitchLabel": "在每個控制台列上顯示時間",
				"readLogFileSwitchLabel": "登錄後從伺服器重新同步控制台紀錄",
				"settingsModalCloseButton": "完成",
				"players_online": "線上人數",
				"cpu_title": "CPU",
				"ram_title": "RAM",
				"user_title": "登錄身份為",
				"deleteServerButton": "關閉伺服器",
				"sendCommandButton": "發送"
			}
			break;
		case "ko_KR":
			lang = {
